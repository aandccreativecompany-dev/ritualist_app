...
/// Monthly goals — a separate list from the daily to-do list, for the
/// bigger things that span the whole month. Newest goal appears on top.
...
class _MonthlyGoalsScreenState extends State<MonthlyGoalsScreen> {
  ...
  Future<void> _add() async {
    ...
    await store.addMonthlyGoal(_controller.text);
    _controller.clear();
    if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      animation: store,
      builder: (context, _) {
        final goals = store.monthlyGoals;
        return Scaffold(
          body: Container(
                ...
                child: Column(
                  children: [
                    ScreenHeader(
                      ...
                      title: 'Monthly goals',
                      subtitle: "The bigger picture — check in on these across the month.",
                      actions: [
                        IconButton(
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Add a goal for this month',
                    ...
                    Expanded(
                      child: goals.isEmpty
                          ? Center(
                              child: Text('No monthly goals yet.',
                                      ...
                                      child: Row(
                                        children: [
                                          CheckSquare(
                                            ...
                                            onTap: () async {
                                              await store.toggleMonthlyGoal(i);
                                          ...
                                          IconButton(
                                            onPressed: () async {
                                              await store.removeMonthlyGoal(i);
                                              if (context.mounted) {
